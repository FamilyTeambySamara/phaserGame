...
window.snowPongGame_7 = {
    ...
    preload: function () {
        ...
        gameLoad().image('snowStuck', 'assets/img/snowPong/snowStuck3.png');
...
//==============Группа ледных блоков
        ...
        iceBrick_1 = iceBricks.create(90, 310, 'iceBrick');
        iceBrick_1.body.bounce.set(0.5);
        // iceBrick_1.angle = 90;
        iceBrick_2 = iceBricks.create(400, 470, 'iceBrick');
...
//=============Группа снежных препятствий==================================
        ...
        var snow_1 = snowGroup.create(100, 600, 'snowStuck');
        snow_1.snow = 'snow';
...
//Группы препятствий и прочих штук на карте==================
        ...
        entity_8 = entityGroup.create(0, 300, 'stoneSmall');
...
//Группа целей====================================================
        ...
        var aim_1 = aimsGroup.create(50, 380, 'crack');
...
//===============================================================
    ...
    update: function (){
      ...
      if (iceBall.sprite.y > 280  && iceBall.status == 'wait'){
        iceBall.sprite.y = 280 ;
      }
      //textDebag
...
var replay = function (){
  ...
  iceBrick_1.reset(90, 310);
  iceBrick_2.reset(400, 470);
