...
window.snowPongGame_2 = {
    ...
    preload: function () {
        ...
        // gameLoad().image('stoneSmall', 'assets/img/snowPong/stone.png');
        gameLoad().image('stoneBig', 'assets/img/snowPong/stone.png');
...
//Группы препятствий и прочих штук на карте==================
        ...
        var entity_stoun_1 = entityGroup.create(215, 250, 'stoneBig');
        entity_stoun_1.body.immovable = true;
        entity_stoun_1.anchor.setTo(0.5, 0.5);
        entity_stoun_1.type = 'stone';
        var entity_stoun_2 = entityGroup.create(320, 350, 'woodBox');
        entity_stoun_2.body.immovable = true;
        entity_stoun_2.inputEnabled = true;
        ...
        var entity_stoun_4 = entityGroup.create(780, 250, 'stoneBig');
