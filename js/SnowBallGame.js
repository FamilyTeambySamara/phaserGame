...
window.Win_SnowBallGame =
{
    ...
    create: function ()
    {
      ...
      var shouwMenu = game.add.tween(menuAnim).to({alpha: 1}, 14000, Phaser.Easing.Exponential.Out, true, 0);


      // winSound.fadeOut(5000);
      ...
      wholeBarstars = this.add.text(272, 217, '0', { fontSize: '32px', fill: 'yellow', font: "mainFont"});
      wholeBarstars.anchor.x = 0.5;
      wholeBartime = this.add.text(397, 217, '0', { fontSize: '32px', fill: 'blue', font: 'mainFont' });
      wholeBartime.anchor.x = 0.5;
      wholeBarhp  = this.add.text(525, 217, '0', { fontSize: '32px', fill: 'red', font: 'mainFont' });
